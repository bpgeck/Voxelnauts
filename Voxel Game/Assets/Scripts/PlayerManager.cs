...
public class PlayerManager : MonoBehaviour {
	...
	void Start () {
		...
		flags = FindObjectsOfType<FlagAudioBroadcaster>();
		flags[0].transform.parent.GetComponent<SetTeamColor>().SetColor();
		flags[1].transform.parent.GetComponent<SetTeamColor>().SetColor();
	}
